...
lty=c(1,1,1,1,1,1,2), cex=1.05, yjust = 0.5, lwd = 3)
...
lwd = 4, ylim = c(0,1160), las = 1, col = "ivory1", cex.lab = 1.5)
...
axis(2,las=1,at=c(0.5,1,2,4,16,32,64,92), labels = c("0·5","1","2·0","4·0","16·0","32·0","64·0","92·0"), lwd = 4)
axis(1, lwd = 4)
...
axis(2,las=1,at=c(0.5,1,4,8,10), labels = c("0·5","1","4·0","8·0","10·0"), lwd = 4)
axis(1, lwd = 4)
lines(x = c(0,120),y = c(1,1),lty = 2, lwd = 4) # as abline seems to overlap
par(lend=1);
...
par(mfrow = c(1,2))
plot(NULL, NULL, xlim = c(0,10), ylim = c(0.5,2), type = "l", xlab = "d", ylab = "", col = scales::alpha("black",0.2), xaxs = "i", yaxs = "i", xaxt = "n", yaxt = "n", lwd = 4, cex.lab = 1.5)
mtext(latex2exp::TeX('$\\tau (d)$'), side=2, line=3, cex = 1.5, padj = 1)
...
plot(NULL, NULL, xlim = c(0,10), ylim = c(0.5,2), type = "l", xlab = "d", ylab = "", 
     ...
     lwd = 4, cex.lab = 1.5)
axis(1, labels = c(0,2,latex2exp::TeX('$\\hat{D}$'),5,6,8,10), at = c(0,2,3.45,5,6,8,10), 
     lwd = 4, las = 1)
axis(2, labels = c("0·5","1","1·5","2·0"), at = c(0.5,1,1.5,2.0), lwd = 4, las = 1)
for (i in 1:100) {
...
lines(seq.int(0,10), tau.sim[1,], type = "l", lwd = 4, col = "blue")
abline(v = 3.45, col = "blue", lty = 2, lwd = 4)
dev.off()
```
