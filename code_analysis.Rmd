...
If you haven't compiled LaTeX before on your Windows OS then downloading the `tinytex` package and running `tinytex::install_tinytex()` can help. Also Replace & Find in RStudio (`Ctrl+Shift+J`) the file paths `/home/tim/measles/figs` & `/home/tim/measles/intrmd8` that may require amending (these are for a Linux OS) according to the system filepath that your cloned repository is in.
